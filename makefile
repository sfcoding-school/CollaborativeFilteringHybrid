...
main: main.o createTestSet.o reccomender.o matrixUser.o matrixItem.o ratingPrediction.o
	g++ -O3 -std=c++0x main.o matrixUser.o matrixItem.o createTestSet.o reccomender.o ratingPrediction.o -o main 
	rm main.o createTestSet.o reccomender.o matrixItem.o matrixUser.o ratingPrediction.o
